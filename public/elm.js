...
var $author$project$Api$flowDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Domain$Flow,
...
var $author$project$Api$generationDecoder = A5(
	...
	$author$project$Domain$Generation,
	A2($elm$json$Json$Decode$field, 'renewables', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'coal', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'gas', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'other', $elm$json$Json$Decode$float));
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $elm$json$Json$Decode$map5 = _Json_map5;
var $author$project$Api$sampleDecoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Domain$Sample,
	A2($elm$json$Json$Decode$field, 'timestamp', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'label', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'generation', $author$project$Api$generationDecoder),
	A2($elm$json$Json$Decode$field, 'price', $elm$json$Json$Decode$float),
	A2(
		$elm$json$Json$Decode$field,
		'flows',
		$elm$json$Json$Decode$list($author$project$Api$flowDecoder)));
var $author$project$Api$datasetDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Domain$Dataset,
	A2($elm$json$Json$Decode$field, 'source', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'sourceStatus', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'period', $elm$json$Json$Decode$string),
	A2(
		$elm$json$Json$Decode$field,
		'samples',
		$elm$json$Json$Decode$list($author$project$Api$sampleDecoder)));
...
var $author$project$Main$legend = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			A2($author$project$Main$legendItem, '#63a35c', 'Erneuerbare'),
...
var $author$project$Domain$partners = function (dataset) {
	return A2(
...
var $author$project$Main$sectionCard = F4(
	function (anchor, title, description, content) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
...
var $author$project$View$FlowMatrix$colorFor = F2(
	function (maxAbs, value) {
		var ratio = A2(
			$elm$core$Basics$min,
			1,
			$elm$core$Basics$abs(value) / maxAbs);
		var blend = F2(
			function (from, to) {
...
var $author$project$Domain$flowFor = F2(
	function (country, sample) {
		return A2(
			$elm$core$Maybe$withDefault,
			0,
			A2(
	...
	function (countries, samples, selectedIndex, selectedPartner, onSelect) {
			...
			A2(
				...
				$elm$core$List$maximum(
					A2(
						...
						countries))));
		var left = 116;
		var cellWidth = 730 / A2(
			$elm$core$Basics$max,
			1,
			$elm$core$List$length(samples));
		var cellHeight = 25;
		var height = $elm$core$Basics$round(
			...
			function (index, sample) {
				return (!A2($elm$core$Basics$modBy, 6, index)) ? A2(
					...
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$x(
							$author$project$View$FlowMatrix$f(left + ((index + 0.5) * cellWidth))),
							$elm$svg$Svg$Attributes$y(
							$author$project$View$FlowMatrix$f(
								(top + (cellHeight * $elm$core$List$length(countries))) + 22)),
							$elm$svg$Svg$Attributes$textAnchor('middle'),
		...
		var cell = F4(
			function (rowIndex, country, col, sample) {
				...
				var active = _Utils_eq(selectedIndex, col) && _Utils_eq(
					selectedPartner,
				...
				return A2(
					...
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$x(
							$author$project$View$FlowMatrix$f(left + (col * cellWidth))),
							$elm$svg$Svg$Attributes$y(
							$author$project$View$FlowMatrix$f(top + (rowIndex * cellHeight))),
							$elm$svg$Svg$Attributes$width(
							$author$project$View$FlowMatrix$f(cellWidth + 0.4)),
					...
					A2(
						...
						A2(
							...
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$x(
									$author$project$View$FlowMatrix$f(left - 10)),
									$elm$svg$Svg$Attributes$y(
									$author$project$View$FlowMatrix$f((top + (rowIndex * cellHeight)) + 17)),
									...
									_Utils_eq(
										selectedPartner,
										$elm$core$Maybe$Just(country)) ? '700' : '400'),
									$elm$svg$Svg$Attributes$fill('#1f2937')
								]),
							_List_fromArray(
								[
									$elm$svg$Svg$text(country)
								])),
						A2(
							$elm$core$List$indexedMap,
							A2(cell, rowIndex, country),
							samples)));
			});
		return A2(
			$elm$svg$Svg$svg,
			_List_fromArray(
				[
					...
					$elm$svg$Svg$Attributes$width('100%'),
					A2($elm$html$Html$Attributes$attribute, 'role', 'img'),
					A2($elm$html$Html$Attributes$attribute, 'aria-label', 'Pixelmatrix der Stromflüsse nach Partnerland und Stunde')
				]),
			_Utils_ap(
...
var $author$project$View$TimeSeries$f = $elm$core$String$fromFloat;
var $author$project$View$TimeSeries$point = F2(
	function (x, y) {
		return $author$project$View$TimeSeries$f(x) + (' ' + $author$project$View$TimeSeries$f(y));
	});
var $author$project$View$TimeSeries$areaPath = F5(
	function (x, y, samples, upper, lower) {
		var topPoints = A2(
			$elm$core$List$indexedMap,
			F2(
				function (index, sample) {
					return A2(
						$author$project$View$TimeSeries$point,
						x(index),
						y(
							upper(sample)));
				}),
			...
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Deutschlands Rolle im europäischen Stromnetz')
									])),
								A2(
								$elm$html$Html$p,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Drei interaktiv verbundene Ansichten für physische Flüsse und Erzeugungsmix')
									]))
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('source-card')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('source-label')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Datenstatus')
									])),
								A2(
								$elm$html$Html$p,
								_List_Nil,
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('source-status')
									]),
								_List_fromArray(
									[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Auswahl zurücksetzen')
							]))
					])),
				A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Vorzeichen: positive Werte = Import nach Deutschland, negative Werte = Export aus Deutschland. Der Erzeugungsmix zeigt zeitgleiche Produktion und keine physische Herkunft einzelner Importmengen.')
					]))
			]));
};
	...
	switch (model.$) {
		case 'Loading':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('state-message')
					]),
				_List_fromArray(
					[
		...
		case 'Failed':
			...
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('state-message error')
					]),
				_List_fromArray(
					[
		...
		default:
			var state = model.a;
			return $author$project$Main$viewDashboard(state);
	}
};
